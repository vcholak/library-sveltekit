	...
	<div class="container mx-auto">
		<div class="py-8">
			<div class="flex flex-wrap flex-row mb-1 sm:mb-0 justify-between w-full">
				<h2 class="text-2xl leading-tight md:pr-0 text-white">Books</h2>
				<div>
					<a href="/admin/books/create" class="px-4 py-2 text-base font-semibold rounded-lg bg-gray-600 text-white hover:bg-purple-700">New Book</a>
				</div>
				<div class="text-end">
			...
			<div class="py-4">
				<div class="max-w-full overflow-x-auto shadow rounded-lg">
					...
					<Pagination items={data.books} bind:trimmedItems={books} />
				</div>
			</div>
		</div>
	</div>
